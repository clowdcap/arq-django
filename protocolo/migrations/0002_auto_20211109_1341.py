# Generated by Django 3.2.8 on 2021-11-09 16:41

from django.conf import settings
from django.db import migrations, models
import django.db.models.deletion
import protocolo.fields
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='modulo',
            name='order',
            field=protocolo.fields.OrdenaCampos(blank=True, default=0),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', protocolo.fields.OrdenaCampos(blank=True)),
                ...
                ('modulo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conteudos', to='protocolo.modulo')),
            ],
            options={
                'ordering': ['order'],
            },
